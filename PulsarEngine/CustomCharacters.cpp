...
static const CharacterOverride customCharacterAssets[] = {
    ...
    {KOOPA_TROOPA, "nk-1", false, CUSTOM_CHARACTER_NAME_BMG(41), L"Koopa Paratroopa", "Jordi6304"},
    ...
    {BOWSER_JR, "jr-2", true, CUSTOM_CHARACTER_NAME_BMG(56), L"Hammer Bro", "UltraWario"},
