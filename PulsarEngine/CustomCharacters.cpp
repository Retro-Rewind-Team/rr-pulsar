...
static const CharacterOverride customCharacterAssets[] = {
    ...
    {MARIO, CUSTOM_CHARACTER_TABLE_SKIN3, "mr-3"},
    ...
    {WALUIGI, CUSTOM_CHARACTER_TABLE_SKIN3, "wl-3"},
    ...
    {DIDDY_KONG, CUSTOM_CHARACTER_TABLE_SKIN3, "dd-3"},
    ...
    {DRY_BOWSER, CUSTOM_CHARACTER_TABLE_SKIN2, "bk-2"},
    ...
    {FUNKY_KONG, CUSTOM_CHARACTER_TABLE_SKIN5, "fk-5"},
