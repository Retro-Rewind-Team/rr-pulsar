...
enum PulPageId {
    ...
    PULPAGE_TTPRACTICESELECT,
    PULPAGE_TTPRACTICECONFIRM,
    PULPAGE_TTPRACTICESETTINGS,

    PULPAGE_MAX = PULPAGE_TTPRACTICESETTINGS - PULPAGE_INITIAL + 1
};
...
enum BMG {
    ...
    // Time Trial Mode Selection (Normal, Practice)
    BMG_TT_NORMAL_BUTTON = 0x6970,
    BMG_TT_PRACTICE_BUTTON = 0x6971,
    BMG_TT_NORMAL_BOTTOM = 0x6972,
    BMG_TT_PRACTICE_BOTTOM = 0x6973,
    BMG_TT_START_RACE_BUTTON = 0x6974,
    BMG_TT_PRACTICE_SETTINGS_BUTTON = 0x6975,
    BMG_TT_START_RACE_BOTTOM = 0x6976,
    BMG_TT_PRACTICE_SETTINGS_BOTTOM = 0x6977,
    BMG_TT_PRACTICE_SETTINGS_TITLE = 0x6978,
    BMG_TT_PRACTICE_SETTINGS_SAVE_BOTTOM = 0x6979,
    BMG_TT_PRACTICE_ITEMBOXES = 0x697a,
    BMG_TT_PRACTICE_ITEMBOXES_ENABLED = 0x697b,
    BMG_TT_PRACTICE_ITEMBOXES_DISABLED = 0x697c,
    BMG_TT_PRACTICE_ITEMBOXES_BOTTOM_ENABLED = 0x697d,
    BMG_TT_PRACTICE_ITEMBOXES_BOTTOM_DISABLED = 0x697e,
};
