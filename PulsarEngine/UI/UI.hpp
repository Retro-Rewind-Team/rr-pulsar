...
enum BMG {
    ...
    // Mogi
    BMG_MOGI_BOTTOM = 0x691e,
    BMG_MOGI_RETRO_BUTTON = 0x691f,
    BMG_MOGI_CT_BUTTON = 0x6930,
    BMG_MOGI_REGULAR_BUTTON = 0x6931,
    BMG_MOGI_FORMAT_TITLE = 0x6933,
    BMG_MOGI_FORMAT_BOTTOM = 0x6934,
    BMG_MOGI_FORMAT_FFA = 0x6935,
    BMG_MOGI_FORMAT_2V2 = 0x6936,
    BMG_MOGI_FORMAT_3V3 = 0x6937,
    BMG_MOGI_FORMAT_4V4 = 0x6938,
    BMG_MOGI_FORMAT_6V6 = 0x6939,
    BMG_COMPETITIVE_ENTRANCE = 0x693a,
    ...
    BMG_MOGI_MMR = 0x6926,
    BMG_MOGI_MMR_CHANGE = 0x6927,
    BMG_MOGI_MMR_VALUE = 0x6928,
