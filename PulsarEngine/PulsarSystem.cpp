...
void System::UpdateContext() {
    ...
    bool isItemModeRandom = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_ITEMMODE) == GAMEMODE_RANDOM && isNotPublic;
    bool isItemModeBlast = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_ITEMMODE) == GAMEMODE_BLAST && isNotPublic;
    bool isItemModeRain = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_ITEMMODE) == GAMEMODE_ITEMRAIN;
    bool isItemModeStorm = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_ITEMMODE) == GAMEMODE_ITEMSTORM;
    bool isTrackSelectionRegs = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_TRACKSELECTION) == TRACKSELECTION_REGS;
    bool isTrackSelectionRetros = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_TRACKSELECTION) == TRACKSELECTION_RETROS && mode != MODE_PUBLIC_VS;
    bool isTrackSelectionCts = settings.GetUserSettingValue(Settings::SETTINGSTYPE_RACE1, SCROLLER_TRACKSELECTION) == TRACKSELECTION_CTS && mode != MODE_PUBLIC_VS;
