...
public:
    ...
    ~ItemActor() override;  // 80706f3c

    // Actor vtable 808c84a0 at 0x54
    //~ItemActor thunk 80707094
    ...
    Handle *StartSoundLimited(u32 soundId, float localVar) override;  // 0x30 thunk 807070e4 func 80704364 checks for conditions before thunk starting
    Handle *HoldSoundLimited(u32 soundId) override;  // 0x34 thunk 807070dc func 807046a0
    void StopAllSound(int fadeOutFrames) override;  // 0x38 thunk 807070d4 func 80705468
    Handle *StartNewSoundLimited(u32 soundId, float volume) override;  // 0x3c thunk 807070cc func 80704998 if an handle is already set, does not start the sound
    bool StartSound(u32 soundId, Handle *handle) override;  // 0x4c thunk 807070bc func 807054cc
    bool StartSound(u32 soundId, Handle *handle, const snd::SoundStartable::StartInfo *startInfo) override;  // 0x50 thunk 807070c4 func 80705540
    bool HoldSound(u32 soundId, Handle *handle) override;  // 0x54 thunk 807070ac func 807055c0
    bool HoldSound(u32 soundId, Handle *handle, const snd::SoundStartable::StartInfo *startInfo) override;  // 0x58 thunk 807070b4 func 80705634
...
public:
    ...
    ~GessoActor() override;  // 80706fc8

    // Actor vtable 808c81e4 at 0x54
    //~GessoActor thunk 80707154 func 80706fc8
    ...
    Handle *StartSoundLimited(u32 soundId, float localVar) override;  // 0x30 thunk 807071a4 func 80704d98 checks for conditions before thunk starting
    Handle *HoldSoundLimited(u32 soundId) override;  // 0x34 thunk 8070719c func 80705040
    void StopAllSound(int fadeOutFrames) override;  // 0x38 thunk 80707194 func 80705158
    Handle *StartNewSoundLimited(u32 soundId, float volume) override;  // 0x3c thunk 8070718c func 80704f84 if an handle is already set, does not start the sound
    bool StartSound(u32 soundId, Handle *handle) override;  // 0x4c thunk 8070717c func 8070516c
    bool StartSound(u32 soundId, Handle *handle, const snd::SoundStartable::StartInfo *startInfo) override;  // 0x50 thunk 80707184 func 807051e0
    bool HoldSound(u32 soundId, Handle *handle) override;  // 0x54 thunk 8070716c func 80705260
    bool HoldSound(u32 soundId, Handle *handle, const snd::SoundStartable::StartInfo *startInfo) override;  // 0x58 thunk 80707174 func 807052d4
