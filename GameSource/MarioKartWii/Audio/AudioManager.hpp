...
public:
    ...
    // ArcPlayer vtable 808c913c at 0xf8
    ~Manager() override;  // 0x2c thunk 80717c40 func 80717004
    ...
    EGG::TDisposer<Manager> disposer;  // 80716d94 vtable 808c91d0
    u8 dvdIsBusy;  // 0x8A4
