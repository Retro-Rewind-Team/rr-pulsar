#ifndef _RKSYS_REQUESTER_
#define _RKSYS_REQUESTER_
#include <kamek.hpp>
#include <MarioKartWii/System/Ghost.hpp>

enum RequestType {  // array position in the class
    REQUEST_ERASE_RKSYS = 0x0,
...
class RKSYSRequester {
   public:
    ...
    RKSYSRequester();  // 806209e8
    ~RKSYSRequester();  // 80620a8c
    void Reset();  // 80620b04
