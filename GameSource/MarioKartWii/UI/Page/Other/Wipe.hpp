...
public:
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x28 806522d0
...
public:
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x60 806522c4
