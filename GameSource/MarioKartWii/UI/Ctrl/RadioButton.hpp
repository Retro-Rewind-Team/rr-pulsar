...
class RadioButtonControl : public LayoutUIControl {
   public:
    ...
    void SetOnClickHandler(const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> &handler);  // 80605d54
    void SetOnSelectHandler(const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> &handler);  // 80605d5c
    void SetOnDeselectHandler(const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> &handler);  // 80605d64
    void SetOnChangeHandler(const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> &handler);  // 80605d6c
    static void Trigger2APtmf(const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> &handler, u32 hudSlotId, u32 curChildId);  // 80607130
    ...
    const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> *onClickHandler;  // 0x1F0
    const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> *onSelectHandler;  // 0x14
    const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> *onDeselectHandler;  // 0x1f8
    const PtmfHolder_3A<Page, void, RadioButtonControl &, u32, u32> *onChangeHandler;  // 0x1fc called by both handle select and deselect
