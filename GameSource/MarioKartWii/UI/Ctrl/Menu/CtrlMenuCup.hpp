...
class CtrlMenuCupSelectCup : public LayoutUIControl {
   public:
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x28 807e63e0
...
class CtrlMenuCupSelectCourse : public LayoutUIControl {
   public:
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x28 807e63d4
