...
class SheetSelectControl : public UIControl {  // arrowpair
   public:
    ...
    const PtmfHolder_2A<LayoutUIControl, void, SheetSelectControl &, u32> *rightArrowHandler;  // 0x98
    const PtmfHolder_2A<LayoutUIControl, void, SheetSelectControl &, u32> *leftArrowHandler;  // 0x9C
