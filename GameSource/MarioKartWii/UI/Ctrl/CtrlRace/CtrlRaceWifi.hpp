...
public:
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x28 807f924c
    ...
    bool IsInactive() override;  // 0x48 807f8bd8 check if raceinfo is above countdown stage, in which case control is made invisible
...
class CtrlRaceWaitSymbol : public CtrlRaceBase {
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x28 807f916c
    ...
    bool IsInactive() override;  // 0x48 807f909c check if raceinfo is above countdown stage, in which case control is made invisible
...
public:
    ...
    const ut::detail::RuntimeTypeInfo *GetRuntimeTypeInfo() const override;  // 0x28 807f91dc
    ...
    bool IsInactive() override;  // 0x48 807f8d88 check if raceinfo is above countdown stage, in which case control is made invisible
