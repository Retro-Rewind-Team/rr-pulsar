...
class ObjectCollisionSphere : public ObjectCollision {  // P4 = 1, P5 is 3D Radius WanWan for example
    ...
    const Vec3 &GetPosition(const Vec3 &unknown) const override;  // 80836920
...
public:
    ...
    const Vec3 &GetPosition(const Vec3 &unknown) const override;  // 8083618c
...
class ObjectCollisionPolyhedra : public ObjectCollision {
    ...
    void SetPositionAndScale(const Mtx34 &transformationMtx, float objScale, const Vec3 &collisionTranslation) override;  // 808367c4
    const Vec3 &GetPosition(const Vec3 &unknown) const override;  // 80836628
    float GetRadius() const override;  // 807f957c diameter
    virtual const Vec3 &vf_0x1c();  // 808342e8
