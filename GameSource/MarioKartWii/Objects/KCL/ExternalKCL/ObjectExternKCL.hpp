...
public:
    ...
    virtual void UpdateCollisionPosition(u32 timeOffset = 0);  // 0x120 8081ad6c has check in place to only update once per frame
    ...
    virtual const Mtx34 &GetTransformationMatrix(u32 framesOffset);  // 0x12c 807feac0
