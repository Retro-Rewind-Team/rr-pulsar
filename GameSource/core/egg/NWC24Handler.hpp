...
public:
    ...
    virtual Error GetMsgFromId(const NWC24::MsgObj *obj, u64 *userId);
    ;  // 0x44 80231d9c
    virtual Error GetMsgNumTo(const NWC24::MsgObj *obj, u32 *numTo);
    ;  // 0x48 80231e20
    ...
    virtual Error SetSearchCondMsgBox(NWC24::MsgBoxId mBoxId);
    ;  // 0xb8 80233038
    virtual Error SearchMsgs(NWC24::MsgObj *msgObjArray, u32 arraySize, u32 *numStored, u32 *numRemain);
    ;  // 0xbc 802330c0
